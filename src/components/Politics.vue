...
export default {
    ...
    mounted() {
        ...
        (async () => {
            ...
            var rss = await parse('https://cors-anywhere.herokuapp.com/http://www.yonhapnewstv.co.kr/category/news/politics/feed/');
            console.log(JSON.stringify(rss, null, 3))
        })();

        parse('https://cors-anywhere.herokuapp.com/http://www.yonhapnewstv.co.kr/category/news/politics/feed/')
            .then((rss) => {
