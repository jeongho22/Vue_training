...
export default {
    ...
    mounted() {
        ...
        (async () => {
            ...
            var rss = await parse('https://cors-anywhere.herokuapp.com/https://newsis.com/RSS/society.xml');
            console.log(JSON.stringify(rss, null, 3))
        })();

        parse('https://cors-anywhere.herokuapp.com/https://newsis.com/RSS/society.xml')
            .then((rss) => {
