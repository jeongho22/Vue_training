...
export default {
    ...
    mounted() {
        ...
        //     var rss = await parse('https://cors-anywhere.herokuapp.com/https://www.mk.co.kr/rss/30100041/');
        //     console.log(JSON.stringify(rss, null, 3))
        // })();

        parse('https://cors-anywhere.herokuapp.com/https://www.mk.co.kr/rss/30100041/')
            .then((rss) => {
